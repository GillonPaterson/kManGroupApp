exports.checkrole= async(role) => {
    ...
    else if (role.jobLink.charAt(0) !== 'h' || role.jobLink.charAt(1) !== 't' || role.jobLink.charAt(2) !== 't' || role.jobLink.charAt(3) !== 'p' || role.jobLink.charAt(4) !== 's' || role.jobLink.charAt(5) !== ':' || role.jobLink.charAt(6) !== '/' || role.jobLink.charAt(7) !== '/')
        return "The link must start with 'https://'"
    else if (role.jobLink.length < 9)
        return "A link must be entered"
    else if (role.jobResponsibilities.length == 0)
